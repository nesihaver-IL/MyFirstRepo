...
Curated collection of resources for AI agent development.
...
- [AWS Bedrock Workshop](https://catalog.workshops.aws/building-with-amazon-bedrock/)
...
- [Continue](https://continue.dev/) - VS Code AI assistant
